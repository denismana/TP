        ...
        switch(op){
            case 1:
                ...
                for(;;){
                    ...
                    c=Propozitie_cauta(&p,text);                     ////////// daca imi gaseste un cuvant incrementeaza contorul
                    if(c){
                        c->contor++;
                    }
                    else{                                   ///////// daca nu gaseste adauga cuvantul in mod obisnuit in lista
                ...
                break;
            case 2:
                for(c=p.prim;c;c=c->urm)printf("%s:%d\n",c->text,c->contor);
                printf("\n");
                break;
            case 3:
